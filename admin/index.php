...
if (!$auth) {
  ...
  $propiedades = "SELECT *FROM propiedades";

  //Visualizamos la consulta SQL

  $query_pro = mysqli_query($db, $propiedades);
...
if ($_SERVER['REQUEST_METHOD']==='POST') {
  ...
  if ($id) {
    ...
    $queryImg = "SELECT imagen FROM propiedades WHERE id = ${id}";
          ...
          <div class="col-12 mt-2">
            <div class="card">
              <div class="card-header d-flex align-items-center">
                <div class="col mr-auto"><h3 class="card-title">Listado de Propiedades</h3></div>
                 <div class="row text-nowrap align-items-center">
                 <div class="col">Nuevo Registro</div>
                 <div class="col"><a href="crear.php"><button class="btn btn-success"><i class="fas fa-plus-circle"></i></button></a></div>
                 </div>
              </div>
            ...
            <div class="card">
             ...
             <?php while($propiedad = mysqli_fetch_assoc($query_pro)):?>
              <input type="hidden" value="<?php echo $propiedad['vendedorid'] ;?>">
                  <tr>
                    <td><?php echo $propiedad['id'];?></td>
                        <td><?php echo $propiedad['titulo'];?></td>
                              <td><img src="../imagenes/<?php echo $propiedad['imagen'];?>" alt="" height="30px" width="30px"></td>
                        <td> $ <?php echo $propiedad ['precio'];?></td>
                    <td>
                      <div class="row text-center">
                        
                                      <div class="col"> <!-- VER DETALLES DEL REGISTRO -->
                                        <button class="btn btn-primary"><i class="fab fa-wpforms"></i></button>
                                      </div>

                              <div class="col mx-0"><!-- EDITAR REGISTRO -->
                                <a href="actualizar.php?id=<?php echo $propiedad['id'];?>"><button class="btn btn-warning"><i class="fas fa-edit"></i></button></a>
                              </div>

                        <div class="col mx-0"> <!-- ELIMINAR REGISTRO -->
                            <form method="POST">
