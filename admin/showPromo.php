...
$promos = "SELECT *FROM promosion WHERE publisher = 1";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id) {
        ...
        $resultPromo = mysqli_query($db, $querPromo);
            ...
            <div class="col-12 mt-2">
                <div class="card">
                    <div class="card-header d-flex justify-content-center">
                        <div class="col">
                            <h3 class="titulo card-title font-weight-bold mx-2">PROMOSIONES</h3> <span class="text-success">ACTIVAS</span>
                               </div>
